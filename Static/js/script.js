...
function showCard(card, activePlayer) {
  if (activePlayer['score'] <= 21) {
    ...
    cardImage.src = '/Users/nati/Documents/JAVASCRIPT_CRASH_COURSE/Static/images/' + card + '.png';
...
function computeWinner() {
  ...
  if (YOU['score'] <= 21) {
    // condition:  higher score than dealer or when dealer busts and you are under 21
